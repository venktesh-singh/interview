...
const Product = (params) => {
   ...
   return (
    <>
        ...
        <TouchableOpacity>
            <Icon name='arrow-back' onPress={() =>  navigation.navigate("Home", {name: 'Home'})} size={30} color={'#000'} style={{ marginRight: 10 }} />
        </TouchableOpacity>

        <View style={styles.listbox}>  
            <View style={[styles.mainbx,styles.emailbottom]}>
            {imageUrl ? ( // If imageUrl is truthy
                <Image
                    source={{ uri: imageUrl }} // Use the imageUrl as the source
                    borderRadius={100}
                    style={{ width: 175, height: 175 }}
                    resizeMode="contain"
                />
                ) : (
                // If imageUrl is falsy
                <Image
                    source={{
                    uri: 'https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5?s=250',
                    }} // Use the default Gravatar image as the source
                    borderRadius={100}
                    style={{ width: 175, height: 175 }}
                    resizeMode="contain"
                />
